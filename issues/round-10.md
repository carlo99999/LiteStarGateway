...
|---|---|---|---|---|
| ISSUE-001 | Le routing decision sono chiavate per nome: router cancellati inquinano i savings e il riuso del nome contamina la storia (export incluso) | high | `persistence/orm.py:212-223`; `domain/ports/routing.py:41-59`; `application/routing/service.py:586-640`; `persistence/router_repository.py:279-288` | Open |
...
| ISSUE-007 | `_savings_aggregate` esegue 3 SELECT non-atomiche per una cifra sola | low | `persistence/router_repository.py:290-323` | Open |
