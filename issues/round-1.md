...
Initial whole-codebase security & quality review of `src/litestar_gateway` (≈6,300 LOC,
hexagonal architecture). Findings below were surfaced by layer-focused reviewers and then
