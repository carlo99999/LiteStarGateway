...
> Databricks and Anthropic additionally support the Phase 2 streaming
> tool-call event contract below. Bedrock streaming tool calls stay fail
> closed — an accepted known limitation, not planned.
