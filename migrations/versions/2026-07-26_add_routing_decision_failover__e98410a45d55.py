"""add routing_decision failover observability columns

Revision ID: e98410a45d55
Revises: aa866e36f33b
Create Date: 2026-07-26 21:25:12.230571
...
revision = 'e98410a45d55'
down_revision = 'aa866e36f33b'
branch_labels = None
depends_on = None
...
def schema_upgrades() -> None:
    ...
    with op.batch_alter_table('routing_decision', schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column(
                'failover_used', sa.Boolean(), nullable=False, server_default=sa.false()
            )
        )
