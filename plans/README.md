...
| 07 | [Budget alerts](07-budget-alerts.md) | 🚧 Phase 0 complete (threshold model + dedup ledger persisted, not yet wired to settlement); Phase 1 next | Proactive spend notifications at % thresholds, off the hot path |
