...
| 11 | [Platform quality gates](11-platform-quality-gates.md) | 🚧 Slice D (dependency ceiling) complete — `mlflow-skinny` pinned `>=3.14,<4` plus a scheduled non-blocking next-major compatibility workflow; Slices A/B/C (request correlation, drift gates, browser E2E) not yet landed on `main` | Request correlation, drift gates, browser E2E, dependency safety |
