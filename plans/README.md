...
| 07 | [Budget alerts](07-budget-alerts.md) | 🚧 Phase 0 + 1 complete (threshold model + dedup ledger + settlement evaluation + delivery outbox wired; no delivery worker/channels yet); Phases 2-3 remaining | Proactive spend notifications at % thresholds, off the hot path |
