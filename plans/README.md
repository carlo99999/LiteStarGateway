...
| 05 | [Cross-provider failover](05-cross-provider-failover.md) | 🚧 Phase 0 (eligibility classifier) complete; Phase 1 (sequential failover) next | Reliability — fall over to another capable candidate on 429/5xx/timeout |
