...
| 10 | [Usage analytics](10-usage-analytics.md) | 🚧 Phase 0 + 1 complete (routed streams attach settled usage to the routing decision, identically to non-streamed calls; bucketed `GET /teams/{id}/usage/timeseries`, dialect-portable SQL bucketing, DST-independent UTC boundaries); Phase 2 (console charts) remains | Accurate streaming savings + temporal cost/token/call charts |
