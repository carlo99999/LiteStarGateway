...
| 10 | [Usage analytics](10-usage-analytics.md) | 🚧 Phase 0 complete (routed streams attach settled usage to the routing decision, identically to non-streamed calls); Phases 1 (timeseries API) and 2 (console charts) remain | Accurate streaming savings + temporal cost/token/call charts |
