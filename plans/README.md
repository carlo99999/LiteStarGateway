...
| 09 | [Responses API Level B](09-responses-level-b.md) | 🚧 Phase 0 + 1a + provider Chat tool replay + streaming tool events (Databricks, Anthropic) complete; Bedrock streaming is an accepted known limit; Vertex thought-signature carrier migrated to unlock Responses next | Contract correctness — faithful tool events on chat-only providers, fail loudly otherwise |
