...
| 05 | [Cross-provider failover](05-cross-provider-failover.md) | 🚧 Phase 0 + 1 complete (non-streamed sequential failover, config, RPM/budget single-charge guarantees); Phase 2 (streaming) next | Reliability — fall over to another capable candidate on 429/5xx/timeout |
