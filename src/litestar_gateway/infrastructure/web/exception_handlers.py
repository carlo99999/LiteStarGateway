...
_STATUS: list[tuple[type[DomainError], int]] = [
    ...
    (RouterGrantNotFound, HTTP_404_NOT_FOUND),
    ...
    (TeamNotSoftDeleted, HTTP_409_CONFLICT),
    ...
    (ModelShared, HTTP_409_CONFLICT),
    (RouterNameExists, HTTP_409_CONFLICT),
    (RouterShared, HTTP_409_CONFLICT),
    (RouterRevisionConflict, HTTP_409_CONFLICT),
    ...
    (InvalidPlaygroundRequest, HTTP_400_BAD_REQUEST),
    (NoRoutableCandidate, HTTP_400_BAD_REQUEST),
    (CredentialMisconfigured, HTTP_400_BAD_REQUEST),
    (InvalidSsoSettings, HTTP_400_BAD_REQUEST),
    (InvalidUsageQuery, HTTP_400_BAD_REQUEST),
